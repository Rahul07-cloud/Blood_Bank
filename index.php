            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="Donor_reg.php" class="btn btn-primary">Register Donor</a>
                    </div>
                </div>
            </div>
			 <div class="col-md-4">
			  ...
			  <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="Search_Donor.php" class="btn btn-primary">Search Donor</a>
                    </div>
                </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="row">
			...
			<ul>
				...
				<li>Each year we need approximately 2,00,000 new donors, as some donors can no longer give blood.</li>

				<li>Most people between the ages of 18-65 are able to give blood.</li>

				<li>Around half our current donors are over 45. That's why we need more young people (over the age of 18) to start giving blood, so we can make sure we have enough blood in the future.</li>
