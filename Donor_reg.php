...
(NAME, FATHER_NAME, GENDER, DOB, BLOOD, BODY_WEIGHT, EMAIL, ADDRESS, AREA, CITY, PINCODE, STATE, CONTACT, VOLUNTARY, VOLUNTARY_GROUP,NEW_DONOR, LAST_D_DATE, DONOR_PIC,COUNTRY)
 VALUES 
 ('{$_POST["NAME"]}', '{$_POST["FATHER_NAME"]}', '{$_POST["GENDER"]}', '{$_POST["DOB"]}', '{$_POST["BLOOD"]}', '{$_POST["BODY_WEIGHT"]}', '{$_POST["EMAIL"]}', '{$_POST["ADDRESS"]}', '{$_POST["AREA"]}', '$cityname', '{$_POST["PINCODE"]}', '{$state}', '{$_POST["CONTACT"]}', '{$_POST["VOLUNTARY"]}', '{$_POST["VOLUNTARY_GROUP"]}', '{$_POST["NEW_DONOR"]}','{$_POST["LAST_D_DATE"]}', '{$img}','{$country}');";
						if($con->query($sql))
							{
								echo '
								<div class="alert alert-success">
									<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
									<strong>Success!</strong> You are registered as a donor.
								</div>
								<div class="clear"></div>
								';
							}
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
							...
							<input type="text" placeholder="Name" id="NAME" name="NAME"  required pattern="[a-zA-Z]{0,10}" class="form-control input-sm">
						</div>
						<div class="form-group">
							<label class="control-label text-primary" for="FATHER_NAME">Father Name</label>
							<input type="text" placeholder="Father Name" id="FATHER_NAME" name="FATHER_NAME" pattern="[a-zA-Z]{0,10}" required class="form-control input-sm">
						</div>
						...
						<div class="form-group">
							...
							<input type="date"  required id="DOB" name="DOB" max="2001-12-31" min="1955-01-01" class="form-control input-sm DATES">
						</div>
						...
						<div class="form-group">
							...
							<input type="number" required placeholder="Weight In Kgs" min="50" max="100" name="BODY_WEIGHT" id="BODY_WEIGHT" class="form-control input-sm">
						</div>
						 <div class="form-group">
						  ...
						  <div class="form-group">
                                ...
                                <input type="text" required name="PINCODE" id="PINCODE" pattern="[0-9]{6}" maxlength="6" class="form-control" placeholder="Insert Pincode">
                          </div>
						   ...
						   <div class="form-group">
                                ...
                                <input type="text" required name="CONTACT" id="CONTACT" pattern="[0-9]{10}" class="form-control" placeholder="Contact No">
                          </div>
						  ...
						  <div class="form-group" id="new">
							<label class="control-label text-primary"  for="NEW_DONOR" required>New Donor</label>
								<select name="NEW_DONOR"  id="NEW_DONOR"  class="form-control input-sm" required>
							...
							<input type="file" required class="form-control"  name="fileToUpload">
						  </div>
						
							  <div class="form-group">
<label class="control-label text-primary" for="rules" >Rules:</label>
								<label class="control-label text-success" required><input type="checkbox" checked id="c2">&nbsp; I have read the eligibility criteria and confirm that i am eligible to donate blood.</label> 
								<label class="control-label text-success" required><input type="checkbox" checked id="c3" >&nbsp; I agree to the Terms and Conditions and consent to have my contact and donor information published to the potential blood recipients.</label>
						  </div>
