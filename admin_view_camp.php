...
$sql="SELECT * FROM camp  $limit ";

 $textline1="Total camps : $rows";
									...
									$list.= "<tr>
										...
										while($row=$result->fetch_assoc())
										{
											...
											$list.="<tr>";
												...
												$list.= "<td>".$row["PLACE"]."</td>";
												$list.="<td>".$row["CAMP_DATE"]."</td>";
												$list.= "<td><a href='admin_del_camp.php?id=".$row["CAMP_ID"]."' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></a></td>";
											$list.="</tr>";
										}
								$list.= "</table>";
						}
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-9" >
			<h3><i class="fa fa-bank"></i> View Camp Details </h3><hr>    
